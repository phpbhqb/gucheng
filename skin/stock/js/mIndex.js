        ...
        success:function(response){
            if(response){
                $.each(response,function(i,news){
                    ...
                    var newstr='<div class="newListItem box"><div class="newsImg"><a href="'+titleurl+'>">';
                    if(news.pImg){
                        newstr+='<img src="'+news.pImg+'"  alt="'+news.alt+'">';
                    }else{
                        newstr+='<img src="'+newsurl+'skin/stock/images/list_default.jpg"  alt="'+news.alt+'">';
                    }

                    newstr+='</a></div><div class="newsCont boxL"><h2><a href="'+titleurl+'">'+news.title+'</a></h2><p>'+news.befrom+'</p></div></div>';
