        ...
        success:function(response){
            if(response){
                $.each(response,function(i,news){
                    ...
                    var newstr='<div class="newListItem box"><div class="newsImg"><a href="'+titleurl+'>"><img src="'+news.pImg+'" width="179" height="123" alt="'+news.alt+'"></a></div><div class="newsCont boxL"><h2><a href="'+titleurl+'">'+news.title+'</a></h2><p>'+news.befrom+'</p></div></div>';
