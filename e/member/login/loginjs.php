...
{
?>
document.write("&raquo;&nbsp;<font color=red><b><?=$myusername?></b></font>&nbsp;&nbsp;<a href=\"/gucheng/e/member/my/\" target=\"_parent\"><?=$groupname?></a>&nbsp;<?=$havemsg?>&nbsp;<a href=\"/gucheng/e/space/?userid=<?=$myuserid?>\" target=_blank>我的空间</a>&nbsp;&nbsp;<a href=\"/gucheng/e/member/msg/\" target=_blank>短信息</a>&nbsp;&nbsp;<a href=\"/gucheng/e/member/fava/\" target=_blank>收藏夹</a>&nbsp;&nbsp;<a href=\"/gucheng/e/member/cp/\" target=\"_parent\">控制面板</a>&nbsp;&nbsp;<a href=\"/gucheng/e/member/doaction.php?enews=exit&ecmsfrom=9\" onclick=\"return confirm(\'确认要退出?\');\">退出</a>");
<?php
	db_close();
	$empire=null;
}
